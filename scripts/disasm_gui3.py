...
# Try the core Gui impl and also LocationInfo/Rect superclasses
for n in ['com/github/manolo8/darkbot/core/objects/Gui.class',
          'com/github/manolo8/darkbot/core/objects/LocationInfo.class',
          'com/github/manolo8/darkbot/core/objects/Rect.class',
    ...
    print('===', n)
    for tname, tdesc in [('getX2', '()D'), ('getY2', '()D'), ('getWidth', '()D'),
                         ('getHeight', '()D'), ('getX', '()D'), ('getY', '()D'),
                         ('click', '(II)V')]:
